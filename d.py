...
class Player(pygame.sprite.Sprite):
    def __init__(self,img):
        ...
        self.image = pygame.transform.rotate(img, 120)
...
choose = [(300, 300, u'PLAY GAME', (11, 0, 77), (250, 250, 30), 0),
          (300, 340, u'EXIT', (11, 0, 77), (230, 250, 30), 1)]
game = Menu(choose)
game.menu()
...
while run:
    ...
    draw_text(screan,100,20,"hp:"+str(main_player.hp))
    draw_text(screan,250,20, "Money:" + str(money))
    draw_text(screan, 400, 20, "KO's:" + str(KO))
    draw_text(screan, 600, 20, "Press `m` to menu")
